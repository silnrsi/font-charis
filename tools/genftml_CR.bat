...
py C:\Users\wardak\Mine\smith_vm\font-charis\tools\psfgenftml.py "source\CharisSIL-Regular.ufo" "tests\DiacsCR.ftml" -t diac -f C -i "source\glyph_data.csv" -s "../results/CharisSIL-Regular.ttf" --scale 200 -l "tests\logs\Diac_CR.log"
