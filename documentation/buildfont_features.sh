...
pandoc -f markdown-smart -F source/pandocfeats.py -s -M testfont="[../results/CharisSIL-Regular.ttf]" -M fontitalic="[../results/CharisSIL-Italic.ttf]" -M testsize=12 --metadata-file=source/metadata.yaml --pdf-engine=xelatex -o CharisSIL-font-features.json source/CharisSIL-font-features.md
